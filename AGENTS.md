...
Vendor-specific behavior, migration notes, and source evidence live in [`agentic-docs/agent-cli-integrations.md`](agentic-docs/agent-cli-integrations.md) and [`wiki/Vendor-Matrix.md`](wiki/Vendor-Matrix.md).
