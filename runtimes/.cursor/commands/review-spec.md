...
Run a readiness review of the planning artifact at the path the user provides before any code work starts. This is the deterministic, user-invokable wrapper around the `spec-reviewer` checklist.
